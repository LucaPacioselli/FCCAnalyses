...
inputDir  = "/eos/user/l/lpaciose/bkg"
...
outputDir  = "/eos/user/l/lpaciose/bkg/output_finalSel/"
...
cutList = {
    ...
    "sel2RecoEle_vetoes": "((n_RecoElectrons==2 && n_RecoMuons==0) || (n_RecoElectrons==0 && n_RecoMuons==2)) && n_RecoPhotons==0 && n_RecoJets==0 && n_RecoPhotons==0",
    ...
    "sel2RecoEle_vetoes_InvMass_15_70": "((n_RecoElectrons==2 && n_RecoMuons==0) || (n_RecoElectrons==0 && n_RecoMuons==2)) && n_RecoPhotons==0 && n_RecoJets==0 && n_RecoPhotons==0 && ((Reco_ee_invMass > 15 && Reco_ee_invMass < 70) || (Reco_mumu_invMass > 15 && Reco_mumu_invMass < 70))", #invariant mass of the final state leptons > 15 GeV and < 70 GeV
