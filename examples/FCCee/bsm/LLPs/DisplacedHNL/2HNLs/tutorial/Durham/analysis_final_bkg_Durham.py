...
inputDir  = "/eos/user/l/lpaciose/bkg2"
...
outputDir  = "/eos/user/l/lpaciose/bkg2/output_finalSel/"
...
cutList = {
    ...
    "sel2RecoEle": "(n_RecoElectrons==2 && n_RecoMuons==0) || (n_RecoElectrons==0 && n_RecoMuons==2)",
    "sel2RecoEle_vetoes": "((n_RecoElectrons==2 && n_RecoMuons==0) || (n_RecoElectrons==0 && n_RecoMuons==2)) && n_RecoPhotons==0", #&& n_RecoPhotons==0 && n_RecoJets==0 
    ...
    "sel2RecoEle_vetoes_InvMass_15_70": "((n_RecoElectrons==2 && n_RecoMuons==0) || (n_RecoElectrons==0 && n_RecoMuons==2)) && n_RecoPhotons==0 && (Reco_ll_invMass > 15 && Reco_ll_invMass < 70)", #&& n_RecoPhotons==0 && n_RecoJets==0  #invariant mass of the final state leptons > 15 GeV and < 70 GeV
...
cutLabels = {
    ...
    "sel2RecoEle": "Exactly 2 electrons OR Exactly 2 muons",
    "sel2RecoEle_vetoes": "Veto photons and jets",
    "sel2RecoEle_vetoes_InvMass_15_70": "15 GeV $< M(\ell,\ell') <$ 70 GeV",
...
histoList = {
    ...
    "Reco_mumu_invMass":   {"name":"Reco_mumu_invMass",   "title":"Reco M_{mumu} [GeV]",           "bin":100,"xmin":0, "xmax":100},    
    "Reco_ll_invMass":   {"name":"Reco_ll_invMass",   "title":"Reco M_{\ell\ell'} [GeV]",           "bin":100,"xmin":0, "xmax":100},    
